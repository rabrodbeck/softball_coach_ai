...
def solve_4_innings():
    # We want to find if there is a 4-inning assignment
    ...
    if solve_4_innings_recursive := solve_inn(1):
        print("Found 4-inning solution!")
        for inn_idx, ass in enumerate(lineup, 1):
            print(f"Inning {inn_idx}: {ass}")
    else:
        print("No 4-inning solution exists at all!")
